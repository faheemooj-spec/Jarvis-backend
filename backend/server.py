    ...
    def do_POST(self):
        ...
        try:
            ...
            if question.lower() in [
                ...
                self.send_json({
                    "reply": "Hello Sir. I am JARVIS. Faheem Sir created me. How can I help you today?"
                })
                return
            ...
            self.send_json({
                "reply": reply or "Sorry Sir, answer nahi mila."
            })

        except Exception as e:
            print("ERROR:", e)
            self.send_json({
                "reply": "Sir, AI connection problem hai."
            })
